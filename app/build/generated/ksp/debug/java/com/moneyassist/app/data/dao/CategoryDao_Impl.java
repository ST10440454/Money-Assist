  ...
  public CategoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCategory = new EntityInsertionAdapter<Category>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `categories` (`id`,`name`,`minimumGoal`,`maximumGoal`) VALUES (nullif(?, 0),?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindDouble(3, entity.getMinimumGoal());
        statement.bindDouble(4, entity.getMaximumGoal());
      }
    };
    ...
    this.__updateAdapterOfCategory = new EntityDeletionOrUpdateAdapter<Category>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `categories` SET `id` = ?,`name` = ?,`minimumGoal` = ?,`maximumGoal` = ? WHERE `id` = ?";
      }
    ...
    return __db.getInvalidationTracker().createLiveData(new String[] {"categories"}, false, new Callable<List<Category>>() {
      ...
      public List<Category> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfMinimumGoal = CursorUtil.getColumnIndexOrThrow(_cursor, "minimumGoal");
          final int _cursorIndexOfMaximumGoal = CursorUtil.getColumnIndexOrThrow(_cursor, "maximumGoal");
          ...
          while (_cursor.moveToNext()) {
            ...
            _tmpMinimumGoal = _cursor.getDouble(_cursorIndexOfMinimumGoal);
            final double _tmpMaximumGoal;
            _tmpMaximumGoal = _cursor.getDouble(_cursorIndexOfMaximumGoal);
            _item = new Category(_tmpId,_tmpName,_tmpMinimumGoal,_tmpMaximumGoal);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public Category call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final double _tmpMaximumGoal;
            _tmpMaximumGoal = _cursor.getDouble(_cursorIndexOfMaximumGoal);
            _result = new Category(_tmpId,_tmpName,_tmpMinimumGoal,_tmpMaximumGoal);
          } else {
            _result = null;
          }
          return _result;
