...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull MaterialButton btnLogin,
      ...
      @NonNull TextInputEditText etUsername, @NonNull CardView formCard,
      @NonNull LinearLayout heroSection, @NonNull TextInputLayout tilPassword,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, btnLogin, btnRegister,
          etPassword, etUsername, formCard, heroSection, tilPassword, tilUsername);
    }
